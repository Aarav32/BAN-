...
def TWO():
	END = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.5005.115 Safari/537.36 RuxitSynthetic/1.0 v6913200827 t1828329430051578250 athfa3c3975 altpub cvcv=2 smf=0;]'
	ua = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.4951.64 Safari/537.36 RuxitSynthetic/1.0 v8223997827448917128 t8230948372178045378 ath259cea6f altpriv cvcv=2 cexpw=1 smf=0;] '+END
	return ua
...
def meyexudi():
  ...
  try:
    httpCaht = requests.get('https://github.com/Aarav32/Approval-/blob/main/Approval.txt').text
    if id in httpCaht:
      #print(fuckyoursali)
     ...
     # time.sleep(0.5)
      ...
      print(' SIUU ')
      print('————————————————————————————————————————————————————————')
      print(' THANK YOU AND ENJOY BAB TOOLS\n————————————————————————————————————————————————————————')
      input(' IF YOU ARE A FREE USER PRESS ENTER ')
      print('————————————————————————————————————————————————————————')
      meyexudi()
  except:
    sys.exit()
